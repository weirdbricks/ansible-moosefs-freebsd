...
setenv ANSIBLE_HOST_KEY_CHECKING False ; ansible mfschunkservers -m raw -a 'env ASSUME_ALWAYS_YES=YES pkg bootstrap -f'
setenv ANSIBLE_HOST_KEY_CHECKING False ; ansible mfschunkservers -m raw -a 'env ASSUME_ALWAYS_YES=YES pkg install python'
